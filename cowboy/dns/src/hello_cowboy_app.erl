...
start(_Type, _Args) ->
        ...
        {'_', [{"/", get_server_handler, []},{"/get_server", get_server_handler, []},{"/get_log", get_log_handler, []}]}%%define maping of url to handlers
    ]),	    
    {ok, _} = cowboy:start_clear(my_http_listener,
        [{port, Port}],%%listen to the port that was in the config file
